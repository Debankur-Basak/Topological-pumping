...
while itr<=max_itr
    ...
    % title(['After',num2str(itr),'iterations for g = ',num2str(g)]);
...
title('Evolution of the initial state for g= ',num2str(g));
...
ylabel('X_{cm}');
xlabel('z'); 
title('Centre of mass for g=',num2str(g));
grid off;
